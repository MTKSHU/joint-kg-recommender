...
class CjTransUPModel(nn.Module):
    def __init__(self,
                L1_flag,
                embedding_size,
                user_total,
        ...
        super(CjTransUPModel, self).__init__()
        ...
        pref_norm_weight = torch.FloatTensor(self.preference_total, self.embedding_size)
