...
def compareLogs(log1, log2, model1, model2, i2kg_map, triple_head_dict, triple_tail_dict, output_file, u_map_reverse=None, i_map_reverse=None, e_map_reverse=None, r_map_reverse=None):
    ...
    with open(output_file, 'w', encoding='utf-8') as fout:
        for u_id in results1:
            if u_id not in results2 : continue
            ...
            output(fout, u_id, target_items, preference2, gold_ids2, i2kg_map, triple_head_dict, triple_tail_dict, u_map_reverse=u_map_reverse, i_map_reverse=i_map_reverse, e_map_reverse=e_map_reverse, r_map_reverse=r_map_reverse)
...
bpr_log = root_path + '/log/ml1m-bprmf-1539870249.log'
transup_log = root_path + '/log/ml1m-transup-eval.log'
...
output_file = root_path + '/log/parse_bpr_transup.log'
...
compareLogs(bpr_log, transup_log, model1, model2, i2kg_map, triple_head_dict, triple_tail_dict, output_file, u_map_reverse=user_vocab_reverse, i_map_reverse=item_vocab_reverse, e_map_reverse=kg_vocab_reverse, r_map_reverse=rel_vocab_reverse)
